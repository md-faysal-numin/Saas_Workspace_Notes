...
//     queryKey: ["public-notes", workspaceId, search, status],
//     queryFn: () =>
//       noteService.getPublicNotes(1, search, status, Number(workspaceId)),
//   });
...
//           />
//         </div>
//         <NoteFilters status={status} onStatusChange={setStatus} />
//       </div>
...
//                     className="p-2 hover:bg-green-50 rounded-full text-gray-600 hover:text-green-600 transition"
//                   >
//                     <ArrowUp size={20} />
//                   </button>
...
//                     className="p-2 hover:bg-red-50 rounded-full text-gray-600 hover:text-red-600 transition"
//                   >
//                     <ArrowDown size={20} />
//                   </button>
//                 </div>
...
//   );
// }
// src/pages/dashboard/PublicNotes.tsx - WITH PAGINATION
import { useState } from "react";
import { useQuery, useMutation, useQueryClient } from "@tanstack/react-query";
import { useParams, Link } from "react-router-dom";
import { Plus, ArrowUp, ArrowDown, FileText, Edit, Trash2 } from "lucide-react";
